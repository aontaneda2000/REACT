...
BOM
  - location
  - navigator: 
      - userAgent: inf del navegador que se esta    utilizando
...
// => Métodos:
// alert: Son ventanas bloqueantes es decir no permiten que el usuario interactue con el usuario, google penaliza a esas paginas.
...
// clg: metodo childsNodes() muestra hijos del nodo body
console.log(document.body);
